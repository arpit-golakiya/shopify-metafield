...
const Index = (props) => {
  const host = process.env.SHOPIFY_API_KEY;
    ...
    return (
        <Page title="Products" subtitle="The Product metafield owner type." fullWidth>
            <Card>
              ...
              >
                {products.length>0 && products.map(({id,title,productType,description,status,vendor,createdAt,featuredImage, totalInventory, legacyResourceId}, index) => {
